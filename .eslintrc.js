 ...
 * vue-js项目eslint指导
 * eslint-disable max-len
 * 1、需要安装 npm install eslint eslint-plugin-vue prettier eslint-plugin-prettier @vue/eslint-config-prettier eslint-config-prettier @babel/eslint-parser vue-eslint-parser --save-dev
 * 2、需要放入 .gitignore .prettier.config.js文件
 * 3、执行命令 npx vue-cli-serve lint --fix
 * 4、修复某个文件  eslint XXX.js --fix
 *
 * react-js项目eslint指导
 * 1、npm install prettier eslint-plugin-import eslint-plugin-jsx-a11y eslint-plugin-prettier eslint-config-prettier eslint-plugin-react --save-dev
 * 2、修改 根据注释下面规则中的 parse, parserOptions, extends, plugins
 * 3、react项目需要关闭修复hooks中依赖项的规则，否则会修改代码逻辑
 * ts项目
 *  yarn add eslint-plugin-react@latest @typescript-eslint/eslint-plugin@latest @typescript-eslint/parser@latest --dev
 *
 */

// 5、修复src的文件 npx eslint src/**/*[.js,.vue,.jsx] --fix   （可以 npx eslint /**/*[.js,.vue,.jsx] --fix 修复所有文件，请配置好忽略文件！！！）
